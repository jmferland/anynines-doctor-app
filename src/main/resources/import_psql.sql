...
INSERT INTO bill(id, merchant_id, customer_id, creationDate, token, descriptor, amount, currency) values( nextval( 'hibernate_sequence') , (SELECT m.id FROM merchant m WHERE m.name = 'Dr. med. Elena Voss') , (SELECT c.id FROM customer c WHERE c.lastName = 'Fisher') , to_date('19 Sep 2013', 'DD Mon YYYY') , '00000000000000000000000000000001' , 'Dr. med. Voss; Invoice Nr. 45230305' , 77.43 , 'EUR');
